...
const LearnAnimals = ({ course }: { course: Course }) => {
    ...
    <CourseContent course={course}>
      ...
      <div className="p-4 bg-[#FFE5E5] border-3 border-[#2D2016] rounded-xl">
        <p className="text-sm font-nunito text-[#2D2016] leading-relaxed">
          💡 <strong>Did you know?</strong> There are over 8.7 million different
          animal species on Earth! Each one is special and unique in its own
          way.
        </p>
      </div>
