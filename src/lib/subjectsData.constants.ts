...
export const coursesData: Course[] = [
  ...
  },
  {
    ...
    subjectId: SubjectId.MATHS,
    label: "Learn Multiplication Tables",
    description: "Learn multiplication tables (2-20) interactively with audio.",
    icon: "twemoji:multiplication-sign",
    route: "/maths/learn-tables",
    component: "learn-tables",
    category: CourseCategory.LEARN,
  },
  {
    id: "maths_practice_tables",
    subjectId: SubjectId.MATHS,
    label: "Practice Multiplication Tables",
    description: "Practice and master multiplication tables (2-20) with streak tracking.",
    icon: "twemoji:multiplication-sign",
    route: "/maths/practice-tables",
    component: "practice-tables",
    category: CourseCategory.PRACTICE,
  },
  {
    id: "stem_units",
